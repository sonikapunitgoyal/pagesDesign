...
class _DiscoverState extends State<Discover> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body:Container(width:deviceWidth,height: deviceHeight, child: SingleChildScrollView(child:  Column(
...
,SizedBox(height: 20.0,)
  ...
  ),title:Text("+919988756636",style:TextStyle(fontWeight:FontWeight.bold)) ,
  )
   ],),)
         
      ,    
         Container(width: 1000.0, height: 50,
